\begin{thebibliography}{99}
	...
	\bibitem{pygmsh_doc} Pygmsh's documentation [Электронный ресурс]: техническая документация / Библиотека документаций 
		языка программирования Python - Режим доступа: https://pygmsh.readthedocs.io/en/latest/, свободный (дата обращения 
		20.05.2019).
%	 Раскоментировать, если в отчете будет картинка 2D_mesh.png
%	\bibitem{wiki_mke} Метод конечных элементов [Электронный ресурс]: статья / Свободная энциклопедия Википедия – Режим 
%		доступа: https://ru.wikipedia.org/wiki/Метод_конечных_элементов, свободный (дата обращения: 19.05.2019).
\end{thebibliography}